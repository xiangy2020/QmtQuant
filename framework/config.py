...
class Config:
    ...
    def __init__(self, config_path: str):
        ...
        # 基准标的（用于构建回测时间轴），缺省沪深300
        raw_benchmark = backtest_config.get("benchmark", "000300.SH")
        # 兼容旧格式 "sh.000300" → "000300.SH"
        if raw_benchmark == "sh.000300":
            raw_benchmark = "000300.SH"
        self.benchmark = raw_benchmark
